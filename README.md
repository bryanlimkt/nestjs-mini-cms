...
## Step-By-Step of Configuring the Microservices

1. `npm i @nestjs/graphql graphql-tools graphql apollo-server-express @nestjs/apollo`
1. `npm i @nestjs/microservices`
